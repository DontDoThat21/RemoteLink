...
/// <summary>
/// Mock input handler for cross-platform development and testing.
/// Logs all input events to the console and supports allowlisted command execution.
/// On Windows, use <see cref="WindowsInputHandler"/> for real input simulation.
/// </summary>
